...
STEPS: List[Step] = [
    ...
    Step(
        ...
        summary=(
            ...
            "in sync with it — "
            "and writes a background report of up to 350 words for the "
            ...
            "rather than into them. A selected event is where a report may go "
            "rather than where one has to: the call first notes what its "
            "sources say about this event in particular, and writes nothing "
            "where that comes to nothing, because an event recorded in half a "
