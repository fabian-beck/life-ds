...
def build_phase2_prompt_base(
    ...
    prompt += "       Kaufungen, 'Nazi youth organization' none of Hitler Youth. Where the sentence gives only\n"
    prompt += "       part of the meaning, the annotation supplies the rest and repeats none of it\n"
    ...
    prompt += "     the description does not already say so. Optional: wikipedia_url for further reading\n"
