...
Choose data deliberately. Inspect registries or visible cards to find a mix of:

- long and short stories;
- many and few images;
- dense and sparse networks;
- migrations or geographically distributed events;
...
- **Blocker:** the primary experience cannot be completed or data is put at risk.
- **Major:** a major feature is unusable with no reasonable workaround.
