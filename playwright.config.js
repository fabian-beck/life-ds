  ...
  projects: [
    {
      name: "logic",
      testMatch:
        /(depthLayer|eventWeight|personNames|historicalDates|relationshipLabels|descriptionSegments|birthEvent|publicationSource|eventClassLabels|gestureAxis|metaStorySections)\.spec\.js/,
      use: {},
    },
    {
