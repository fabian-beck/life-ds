  ...
  projects: [
    {
      name: "logic",
      testMatch:
        /(depthLayer|eventWeight|personNames|personInitials|historicalDates|relationshipLabels|descriptionSegments|birthEvent|publicationSource|eventClassLabels|gestureAxis|metaStorySections|styleVars|storyModel|localizedData|localeCoverage)\.spec\.js/,
      use: {},
    },
    {
