 ...
 * the same way. Served from a domain root those paths are correct as-is, but a
 * GitHub Pages project page serves the app from a subdirectory
 * (`import.meta.env.BASE_URL === "/life-ds/"`), where they would resolve
